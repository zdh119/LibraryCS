...
RegisterWidget::RegisterWidget(QWidget *parent) : QWidget(parent)
{
    ...
    accountLineEdit->setPlaceholderText("请输入账户");
    ...
    setWindowTitle("图书管理系统用户注册");
//    setWindowIcon(QIcon("D:\\Desktop\\图标\\register.ico"));
...
//    this->setPalette(palette);
    ...
    connect(registerButton, &QPushButton::clicked, this, &RegisterWidget::registerButtonClick);
}

//注册账户
void RegisterWidget::registerButtonClick(){
    ...
    if(account==""||password==""){
        ...
        qDebug()<<(QString::number(m->type)+m->data).toUtf8();
